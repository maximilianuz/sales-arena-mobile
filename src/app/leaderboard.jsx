...
const styles = StyleSheet.create({
  ...
  tabActive: { backgroundColor: 'rgba(94,92,230,0.25)', borderColor: 'rgba(94,92,230,0.5)' },
  ...
  rowMe: { backgroundColor: 'rgba(94,92,230,0.12)', borderWidth: 1, borderColor: 'rgba(94,92,230,0.4)' },
